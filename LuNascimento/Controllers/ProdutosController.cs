...
namespace LuNascimento.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Preco,Foto,CategoriaId")] Produto produto, IFormFile formFile)
        {
            ...
            if (formFile != null)
            {
                ...
                string uploads = wwwRootPath + "/img/produto/" + produto.Id.ToString();
                string newFile = Path.Combine(uploads, fileName);
                using (var stream = new FileStream(newFile, FileMode.Create))
                {
                    formFile.CopyTo(stream);
                }
                produto.Foto = "/img/produto/" + fileName;
                await _context.SaveChangesAsync();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Preco,Foto,CategoriaId")] Produto produto, IFormFile formFile)
        {
            if (id != produto.Id)
            {
                return NotFound();
